...
export default function TabletsPage({ onAddToCart }) {
    ...
    useEffect(() => {
        async function loadProducts() {
            try {
                ...
                // Assuming all products are Tablets as per current data structure,
                // or we can filter by category/brand if added later.
                // For now, filtering by stock > 0 as requested ("in inventory")
                const inStock = data.filter(p => p.stock > 0 && (p.category === 'tablet'))
        ...
        <div className="home-page">
            ...
            <section className="products-section" style={{ paddingTop: '120px' }}>
                ...
                <div className="products-grid">
                    {products.length === 0 ? (
                        <div className="no-products">No Tablets available in inventory at the moment.</div>
                    ) : (
